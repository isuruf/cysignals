...
cdef inline PyObject* interrupt_occurred():
    """
    ...
    The implementation is based on reference counting to check whether
    the exception has been deleted. This means that it will break if the
    exception is stored somewhere or if the exception is involved in a
    reference cycle.
    """
